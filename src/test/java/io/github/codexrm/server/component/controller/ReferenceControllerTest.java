package io.github.codexrm.server.component.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import io.github.codexrm.server.component.DTOConverter;
import io.github.codexrm.server.controller.ReferenceController;
...
class ReferenceControllerTest {
    ...
    void shouldExportReferences() throws Exception {
        ...
        doAnswer(invocation -> {
            ...
            Files.write(file.toPath(), "test".getBytes()); // 👈 crea archivo fake
            return null;
